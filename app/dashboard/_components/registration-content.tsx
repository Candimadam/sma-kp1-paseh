    ...
    return (
        ...
        <main className="flex-1 flex flex-col h-screen overflow-y-auto p-4 md:p-8 pt-16 md:pt-8 bg-neutral-50 dark:bg-neutral-800">
            ...
            <div className="md:hidden space-y-4 mb-10">
                {filtered.map((siswa) => (
                    <div key={siswa.id} className="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 p-4">
                        {/* Header Card */}
                        <div className="flex items-start justify-between mb-3">
                            <div className="flex-1">
                                <h3 className="font-semibold text-lg text-gray-900 dark:text-gray-100 mb-1">{siswa.namaLengkap}</h3>
                                <Badge
                                    variant={
                        ...
                        <div className="space-y-2 mb-4">
                            <div className="flex items-center gap-2 text-sm">
                                ...
                                <span className="text-gray-600 dark:text-gray-200">{enumToReadable(siswa.jenisKelamin)}</span>
                            </div>
                            <div className="flex items-center gap-2 text-sm">
                                <School className="w-4 h-4 text-gray-500 dark:text-gray-400" />
                                <span className="text-gray-600 dark:text-gray-200">{siswa.sekolahAsal}</span>
                            </div>
                            <div className="flex items-center gap-2 text-sm">
                                <GraduationCap className="w-4 h-4 text-gray-500 dark:text-gray-400" />
                                <span className="text-gray-600 dark:text-gray-200">{siswa.nomorTelepon}</span>
                            </div>
                            {siswa.rekomendasiDari && (
                                <div className="flex items-center gap-2 text-sm">
                                    <TrendingUp className="w-4 h-4 text-gray-500 dark:text-gray-400" />
                                    <span className="text-gray-600 dark:text-gray-200">{siswa.rekomendasiDari}</span>
                                </div>
                            )}
                        </div>
                ...
                {filtered.length === 0 && (
                    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 p-8 text-center">
                        <p className="text-sm text-gray-500 dark:text-gray-400">Tidak ada data yang cocok dengan filter/pencarian.</p>
                    </div>
                )}
            </div>
                    ...
                    <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        {filtered.map((siswa, idx) => (
                            <tr key={idx} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                                <td className="px-4 py-3 font-medium text-gray-900 dark:text-gray-100">{siswa.namaLengkap}</td>
                                <td className="px-4 py-3 text-gray-900 dark:text-gray-100">{enumToReadable(siswa.jenisKelamin)}</td>
                                <td className="px-4 py-3 text-gray-900 dark:text-gray-100">{siswa.sekolahAsal}</td>
                                <td className="px-4 py-3 text-gray-900 dark:text-gray-100">{siswa.nomorTelepon}</td>
                                <td className="px-4 py-3 text-gray-900 dark:text-gray-100">{siswa.rekomendasiDari}</td>
