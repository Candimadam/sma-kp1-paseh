...
export function EditRegistrationForm({ registration }: EditRegistrationFormProps) {
    const trpc = useTRPC();
    ...
    const studentUpdateRegisterMutationOptions = trpc.registration.updateRegistration.mutationOptions({
        onSuccess: (data) => {
    ...
    const studentUpdateRegisterMutation = useMutation(studentUpdateRegisterMutationOptions)
