...
const ImageCarrousel = ["/halaman-utama/Background1.jpg", "/halaman-utama/Background2.jpg", "/halaman-utama/Background3.jpg"];
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-[calc(64px+10px)] dark:bg-neutral-900">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-neutral-500/70 to-neutral-500/50 dark:from-neutral-900/80 dark:to-neutral-900/60" />
      </div>
      ...
      <div className="relative z-10 mx-auto px-8 text-center text-white dark:text-white">
        <div className="max-w-4xl mx-auto">
          <h1 className="scroll-m-20 text-center text-6xl mb-6 font-extrabold tracking-tight text-balance dark:text-blue-200">
            Selamat Datang di
            <span className="block text-yellow-300 dark:text-yellow-400">SMA KP 1 PASEH</span>
          </h1>
          <p className="text-xl mb-8 text-white/90 max-w-2xl mx-auto dark:text-neutral-200">Membangun generasi unggul dengan pendidikan berkualitas, karakter kuat, dan masa depan gemilang untuk Indonesia yang merdeka.</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-2xl mx-auto animate-fade-in mb-6">
            <div className="text-center">
              <div className="flex items-center justify-center mb-2">
                <Users className="h-8 w-8 text-yellow-300 dark:text-yellow-400" />
              </div>
              <div className="text-3xl font-bold dark:text-blue-200">456</div>
              <div className="text-white/80 dark:text-neutral-200">Siswa Aktif</div>
            </div>
            <div className="text-center">
              <div className="flex items-center justify-center mb-2">
            ...
            <div className="text-center">
              ...
              <div className="text-3xl font-bold dark:text-blue-200">5</div>
              <div className="text-white/80 dark:text-neutral-200">Ekstrakurikuler</div>
            </div>
          </div>
        </div>
      </div>
